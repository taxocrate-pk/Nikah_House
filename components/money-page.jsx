...
export default function MoneyPage({ page }) {
  ...
  const faqs = online
    ...
    : [
        ...
        [`Is this service available outside ${page.place.name}?`, 'Court Marriage through Nikah House is a Pakistan-based service offered through the listed Pakistani city pages. International couples may instead discuss Online Nikah and overseas document-use requirements.'],
      ]
  ...
  const schema = {
    ...
    '@graph': [
      ...
      { '@type': 'LegalService', name: subject, serviceType: online ? 'Online Nikah Services' : 'Court Marriage Services', areaServed: page.areaServed, provider: { '@type': 'Organization', name: 'Nikah House', url: 'https://nikahhouse.com' }, description: page.description },
