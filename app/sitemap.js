import { courtMarriageSlugs, onlineMarriageSlugs, onlineNikahSlugs } from '@/lib/service-pages'
...
export default function sitemap() {
  ...
  return [
    ...
    ...onlineMarriageSlugs.map(slug => ({ url: `https://nikahhouse.com/online-marriage/${slug}`, lastModified, changeFrequency: 'monthly', priority: 0.9 })),
