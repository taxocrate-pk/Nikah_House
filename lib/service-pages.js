...
export function getOnlineNikahPage(slug) {
  ...
  return {
    ...
    slug,
    place,
    title: `Online Nikah for Couples in ${place.name} | NikahHouse.com`,
    ...
    intro: `NikahHouse.com coordinates Online Nikah services for couples living in or connected with ${place.name}. The service addresses the Islamic ceremony, identity and consent, witnesses, representation where appropriate, Nikahnama preparation and the separate steps required for civil or official use.`,
...
export function getCourtMarriagePage(slug) {
  ...
  return {
    ...
    slug,
    place,
    title: `Court Marriage in ${place.name} | NikahHouse.com`,
    ...
    intro: `NikahHouse.com provides Court Marriage services in ${place.name}, Pakistan, for adult couples marrying through free consent. We coordinate the Nikah, witnesses, Nikahnama particulars, supporting documentation and the route to official registration with the competent Pakistani authority.`,
